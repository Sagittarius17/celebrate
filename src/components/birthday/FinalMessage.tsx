  ...
  return (
    <div className="flex flex-col items-center justify-center pt-16 relative z-10">
      <div className={cn(
        ...
        <Card className="border-none shadow-[0_20px_50px_rgba(0,0,0,0.1)] rounded-[2rem] sm:rounded-[3rem] overflow-hidden bg-white/95 dark:bg-card/90 candle-light:bg-black/70 candle-light:shadow-[0_0_50px_rgba(255,215,0,0.2)] backdrop-blur-md relative z-20 w-full mb-12">
          ...
          <CardContent className="p-8 sm:p-12 text-center space-y-4 sm:space-y-6 pt-12 sm:pt-16">
            ...
            <h3 className="text-2xl sm:text-3xl md:text-4xl font-bold text-slate-900 candle-light:text-foreground">
              To Many More Years of Joy, {recipientName}!
            </h3>
            <p className="text-lg sm:text-xl md:text-2xl text-slate-700 dark:text-muted-foreground candle-light:text-foreground/90 italic leading-relaxed font-medium">
              "{quote}"
            </p>
